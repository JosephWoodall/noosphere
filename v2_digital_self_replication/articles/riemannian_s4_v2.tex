...
Under a rigorous leakage-safe five-fold leave-one-subject-out (LOSO) protocol on the PhysioNet Motor Imagery dataset (20 subjects, 3-class MI, 69 trials per subject), we evaluate eight conditions and report two key findings.
