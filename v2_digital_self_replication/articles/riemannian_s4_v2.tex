...
(1) EEGNet ($38.4\%$, fully supervised), JEPA encoder ($36.6\%$, self-supervised), and JEPA encoder pretrained on BCI2a ($34.8\%$) are all statistically equivalent and $\approx\!22$\,pp below CSP+LDA ($60.1\%$ and $58.7\%$ respectively);
